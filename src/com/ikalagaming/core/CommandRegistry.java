...
/**
 * Handles storing and managing commands for
 * controlling the server. Commands are case insensitive.
 * @author Ches Burks
 *
 */
public class CommandRegistry {
	...
	/**
	 * A list of all of the commands registered.
	 * This list is sorted.
	 */
	...
	/**
	 * Constructs a new command registry and sets up the
	 * internal structures.
	...
	/**
	 * Attempts to register the command for the given class. If
	 * the command already exists, an error is logged and the
	...
	/**
	 * Returns the package that registered the given string,
	...
	/**
	 * Returns the index of the given string if it exists.
	 * If it is not in the array, returns -1.
	 *
	 * @param s the string to look for
