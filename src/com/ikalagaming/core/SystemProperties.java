...
public class SystemProperties {
	 ...
	 * For example, the game 'TextGame's folder would look like
	 * <code>getHomeDir() + "/TextGame/"</code> on a Windows computer.
	 * <table summary="The associated directory">
     * <tr><th>Operating System</th>
     *     <th>Directory</th></tr>
     * <tr><td>WINDOWS</td>
     *     <td><code>System.getenv("APPDATA")</code></td></tr>
     * <tr><td><code>MAC</code></td>
     *     <td>Users home directory
					+ <code>"/Library/Application Support"</code></td></tr>
     * <tr><td><code>LINUX</code></td>
     *     <td>Users home directory</td></tr>
     * <tr><td><code>UNKNOWN(anything else)</code></td>
     *     <td>The user's current working directory</td></tr>
     * </table>
     * <p>
	 ...
	 * <code>System.getProperty("os.name")</code>. Please note that this is
	 * not the same thing as {@link #getOS()}.
	 *
	 * @see #getOS()
	...
	/**
	 * Determines the application data folder based on the OS type.
