...
public class ScriptingSettings {
	 ...
	 */
	public static String TRAILING_CHAR = ";";
	 ...
	 * The java equivalent of this is {@code "("}.
	 */
	public static String ARGUMENT_BEGIN = "(";
	 ...
	 * to the {@code "#"} in C++.
	 */
	public static String COMPILER_CHAR = "#";
