...
public class ArrayOperations {
	...
	/**
	 * Converts the given array into a String that can be output.
	 * The String will start with '[', end with ']' and have
	 * values separated by ','. Empty arrays will output "[]".
	 * The values are determined by the objects
